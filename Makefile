...
tools-dist:
	...
	GOOS=darwin go build -o bin/darwin/pivot -ldflags="-s -w" github.com/ghetzel/pivot/pivot
	GOOS=linux  go build -o bin/linux/pivot  -ldflags="-s -w" github.com/ghetzel/pivot/pivot
